---
title: "Dealing with Specific Types of Variables"
...
All this time we have been downloading packages from CRAN (Comprehensive R Archive Network). 
...
# Strings {.inverse background-color="#A51C30"}
...
# Dates {.inverse background-color="#A51C30"}
...
- Cambridge is UTC-5 (5 hours behind UTC) between first Sunday of November and second Sunday of March which is specified as Eastern Standard Time (EST) and UTC-4 during rest of the year which is specified as Eastern Daylight Time (EDT). 
...
# Factors {.inverse background-color="#A51C30"}
